    ...
    return (
      <div className="buy-ether__action-content-wrapper">
        ...
        <div className="buy-ether__body-text">
          Coinbase is the world’s most popular way to buy and sell bitcoin cash.
        </div>
      ...
      case OPTION_VALUES.QR_CODE:
        return (
          <div className="buy-ether__action-content-wrapper">
            ...
            />
            <div className="buy-ether__body-text">
              Deposit Bitcoin Cash directly into your account.
            </div>
            <div className="buy-ether__small-body-text">
              (This is the account address that Badger created for you to
              recieve funds.)
            </div>
            <div className="buy-ether__buttons">
              <button
