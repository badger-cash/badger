...
module.exports = class AppBar extends Component {
  ...
  renderAppBarAppHeader () {
    ...
    const { isNetworkMenuOpen, isMainMenuOpen } = this.state
  ...
  renderNetworkDropdown () {
    const { dispatch, frequentRpcList: rpcList, provider } = this.props
    const { type: providerType, rpcTarget: activeNetwork } = provider
